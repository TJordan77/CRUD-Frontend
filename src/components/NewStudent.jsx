        ...
        <>
            ...
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit} className='student-form'>
                    ...
                    <input type="number" name="gpa" placeholder="GPA" onChange={handleChange} value={studentInfo.gpa} min="0"
                        max="4" step="0.01" required />
                    <input type="url" name="imageUrl" placeholder="Student Image URL" onChange={handleChange} value={studentInfo.imageUrl} required />
                    <label htmlFor="campuses">Select a Campus:</label>
                    <select name="campusId" id="campuses" value={studentInfo.campusId} onChange={handleChange} required>
